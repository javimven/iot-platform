...
/// Alcanzada hoy desde la rama "Infraestructura" del menú lateral (Etapa 14
/// V2, BACKLOG.md #29) — Alertas/Sesiones/Miembros/Organización/Auditoría/
/// Panel de plataforma, que antes vivían en la `AppBar` de esta pantalla,
/// ahora cuelgan del menú lateral y de su icono de Perfil (`AppShell`), para
/// no ofrecer dos caminos distintos al mismo sitio.
