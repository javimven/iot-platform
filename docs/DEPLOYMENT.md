...
- [x] Compilar `flutter build web` (Etapa 14) apuntando a la API real (`--dart-define=API_BASE_URL=https://staging-api.jmvsoluciones.com/v1`) y copiarlo a `/opt/iot-platform/web/` en la VPS (2026-08-04) — verificado: `https://staging-app.jmvsoluciones.com/` sirve la app real, y el preflight CORS entre ambos orígenes responde correctamente.
